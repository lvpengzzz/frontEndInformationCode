...
export default {
  ...
  methods:{
    loadRoles(){
      request.get("/baseUserController/findAll")
      .then(response => {
    ...
    saveUserHandler(){
      request.request({
        url:'/baseUserController/saveOrUpdate',
        method:'post',
        headers:{
    ...
    loadUsers(){
      request.get("/baseUserController/casecadeRoleFindAll")
      .then(response => {
    ...
    setRolesHandler(){
      request.request({
        url:'baseUserController/setRoles',
        method:'post',
        headers:{
          'Content-Type':'application/x-www-form-urlencoded'
        },
